...
public class IcalWindow extends JApplet implements ActionListener {
    ...
    JLabel lHourF,lTitle,lTimezone,lDateStart,lDateEnd, lTabTitle;
    JComboBox cTimezone;
    JTextArea tTitle, tDateStart, tDateEnd, tTabTitle;
    JTable jtBootom;
    JApplet iCal = this;
    ...
    public void init()
    {
        ...
        lDateStart.setBounds(20,170,400,39);
        add(lDateStart);
        
        lDateEnd = new JLabel("DateEnd");
        lDateEnd.setBounds(200,170,400,39);
        add(lDateEnd);
        
        lTabTitle = new JLabel("Title");
        lTabTitle.setBounds(380,170,400,39);
        add(lTabTitle);
        ...
        tDateStart.setBounds(20, 200, 100, 20);
        add(tDateStart);
        
        tDateEnd = new JTextArea("");
        tDateEnd.setBackground(Color.LIGHT_GRAY);
        tDateEnd.setBounds(200, 200, 100, 20);
        add(tDateEnd);
        
        tTabTitle = new JTextArea("");
        tTabTitle.setBackground(Color.LIGHT_GRAY);
        tTabTitle.setBounds(380, 200, 100, 20);
        add(tTabTitle);
